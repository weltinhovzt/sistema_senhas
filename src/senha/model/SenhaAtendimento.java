 ...
 * @author welti_000
 */
public class SenhaAtendimento extends Senha {

    private int id_senhaAtendimento;
    ...
    public int getId_senhaAtendimento() {
        return id_senhaAtendimento;
    }

    public void setId_senhaAtendimento(int id_senhaAtendimento) {
        this.id_senhaAtendimento = id_senhaAtendimento;
    }
