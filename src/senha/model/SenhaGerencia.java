 ...
 * @author welti_000
 */
public class SenhaGerencia extends Senha{

    private int id_senhaGerencia;
    ...
    public int getId_senhaGerencia() {
        return id_senhaGerencia;
    }

    public void setId_senhaGerencia(int id_senhaGerencia) {
        this.id_senhaGerencia = id_senhaGerencia;
    }
