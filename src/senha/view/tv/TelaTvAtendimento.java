...
import senha.control.AtualizadorComponentsAtendimento;
 ...
 * @author welti_000
 */
public class TelaTvAtendimento extends javax.swing.JFrame {
    boolean emExecucao = true;
    private  List<SenhaAtendimento> ultimasSenhas;

    /**
     * Creates new form TelaPrincipal
     */
    public TelaTvAtendimento() {
        initComponents();
        ultimasSenhas = new ArrayList<>();
        AtualizadorHorario horario = new AtualizadorHorario();
        jLData.setText(horario.dataSistema());
        AtualizadorHorario.horaSistema(jLHora);
        AtualizadorComponentsAtendimento.atualizarCompents(jLSenha, jLGuiche, jLultimaSenha1,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTvAtendimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaTvAtendimento().setVisible(true);
            }
        });
    }
