...
import senha.control.AtualizadorComponentsCaixa;
 ...
 * @author welti_000
 */
public class TelaTvCaixa extends javax.swing.JFrame {
    ...
    public TelaTvCaixa() {
        ...
        AtualizadorHorario.horaSistema(jLHora);
         AtualizadorComponentsCaixa.atualizarCompents(jLSenha, jLGuiche, jLultimaSenha1,
                jLGuiche1,jLultimaSenha2,jLGuiche2,jLultimaSenha3,jLGuiche3,jLultimaSenha4,jLGuiche4);

        JFXPanel fXPanel = new JFXPanel();
        fXPanel.setSize(940, 555);
        fXPanel.setLocation(420, 1);
        fXPanel.setVisible(true);

        this.add(fXPanel);
        MediaHelper.initVideo(fXPanel, new Media("file:///D://videos//video01.mp4"));
    ...
    private void initComponents() {
        ...
        jLSenha.setFont(new java.awt.Font("Tahoma", 1, 112)); // NOI18N
        jLSenha.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLSenha.setText("CN000");
        ...
        jLultimaSenha1.setBounds(290, 560, 180, 50);
        ...
        jLultimaSenha2.setBounds(510, 560, 180, 50);
        ...
        jLultimaSenha3.setBounds(730, 560, 180, 50);
        ...
        jLultimaSenha4.setBounds(950, 560, 180, 50);
        ...
        jLFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/senha/img/LayoutvCaixa.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTvCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTvCaixa().setVisible(true);
            }
        });
    }
